...
Collect 52 features for initial SS prediction by RBSURpred
*/
...
int main(int argc, char *argv[])
{
	...
	while (res_pos < seqLength)
	{
		...
		char *pssm_val;
		if(pssm_flag == 1)pssm_val = substring(pssmline, 11, 79);
		else if(pssm_flag == 0)pssm_val = substring(pssmline, 10, 60);
